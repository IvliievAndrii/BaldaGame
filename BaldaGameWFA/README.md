...
The word must be read by moving along a chain of spaces which are horizontally or vertically connected, cannot use any letter twice and mgitust involve the letter the player has added.
